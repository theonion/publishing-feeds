...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Section.url'
        db.alter_column(u'core_section', 'url', self.gf('django.db.models.fields.URLField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Section.url'
        db.alter_column(u'core_section', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
